package com.afns.tamws.mod.afn.entity.render;
...
public class DirtArrowRenderer extends EntityRenderer<DirtArrowEntity> {

    public DirtArrowRenderer(EntityRendererManager renderManager) {
        super(renderManager);
    }

    public void render(DirtArrowEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
        matrixStackIn.push();
    ...
    @Override
    public ResourceLocation getEntityTexture(DirtArrowEntity entity) {
        return new ResourceLocation("afnmod", "textures/entity/projectiles/dirt_arrow.png");
    }
}
